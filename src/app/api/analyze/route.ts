...
function buildAnalyzePrompt(gradeLevel: string, language: string, uiLang: string): string {
  const convLangLabel: Record<string, string> = { ja: "日本語", en: "英語", pt: "ポルトガル語", vi: "ベトナム語", ru: "ロシア語", zh: "中国語", de: "ドイツ語" };
  const convLangName: Record<string, string> = { ja: "Japanese", en: "English", pt: "Portuguese", vi: "Vietnamese", ru: "Russian", zh: "Chinese", de: "German" };
